...
#define ac reinterpret_cast<decltype(&AllocConsole)>(GetExportAddress(hKernel32, xc("AllocConsole")))()
#define fc reinterpret_cast<decltype(&FreeConsole)>(GetExportAddress(hKernel32, xc("FreeConsole")))()
#define sstdh(x, y) reinterpret_cast<decltype(&SetStdHandle)>(GetExportAddress(hKernel32, xc("SetStdHandle")))(x, y)
#define gtc(x, y) reinterpret_cast<decltype(&GetThreadContext)>(GetExportAddress(hKernel32, xc("GetThreadContext")))(x, y)
